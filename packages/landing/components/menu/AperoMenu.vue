<template>
  <div>
    <div class="pb-5 border-b border-gray-200">
      <h3 class="text-3xl leading-6 font-black text-gray-900 uppercase ml-2">Apero'Cab</h3>
    </div>
    ...
    <div v-else-if="appetizers && !loading" class="py-5 flex flex-wrap gap-4">
      <MenuItem v-for="appetizer in appetizers" :key="appetizer.id" :item="appetizer"/>
    </div>
  </div>
</template>
