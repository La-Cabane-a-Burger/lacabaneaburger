...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routes":{},"envPrefix":"NUXT_"},"apiURL":"http://localhost:4000","mapboxToken":"pk.eyJ1IjoibWFyY2VhdWRhdmlkIiwiYSI6ImNqeWYxMW54bzBkOHMzaHBvM2MxazB3dXoifQ.xaWKNP7nBjO8ioeinDwzDg","public":{"apiURL":"http://localhost:4000","mapboxToken":"pk.eyJ1IjoibWFyY2VhdWRhdmlkIiwiYSI6ImNqeWYxMW54bzBkOHMzaHBvM2MxazB3dXoifQ.xaWKNP7nBjO8ioeinDwzDg"}};
...
const _lazy_212194 = () => import('../handlers/renderer.mjs').then(function (n) { return n.a; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_212194, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_212194, lazy: true, middleware: false, method: undefined }
];
