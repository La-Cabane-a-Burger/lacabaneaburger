          ...
          <Menu as="div" class="ml-3 relative">
            <div>
              <MenuButton
                ...
                <UserCircleIcon class="h-8 w-8 text-gray-700"/>
                <span class="hidden ml-3 text-gray-700 text-sm font-medium lg:block"><span class="sr-only">Open user menu for </span>Valentin Guibert</span>
...
export default defineComponent({
  ...
  props: {
    title: { type: String, default: 'Good morning'},
